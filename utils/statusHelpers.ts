 ...
 * Orders reference status by ID; label/color are for display only.
 */

import type { OrderStatusConfiguration } from '../types';
...
/** Resolve status config by id or label (for raw string like activity meta) */
